...
namespace DDO.Domain.TdsModule
{
    public class Tds : IHaveAccountingUnit, IHaveDateFilter
    {
        ...
        public Tds(int supplierId, DateTime date, string placeOfSupply, string reference, double amountPaid, double cgstAmount,
        ...
        public void Modify(int supplierId, DateTime date, string placeOfSupply, string reference, double amountPaid, double cgstAmount,
